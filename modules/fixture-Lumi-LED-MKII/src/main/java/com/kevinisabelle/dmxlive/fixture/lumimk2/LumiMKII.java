package com.kevinisabelle.dmxlive.fixture.lumimk2;
...
import static com.kevinisabelle.dmxlive.core.fixture.AbstractFixture.OP_FADE;
import static com.kevinisabelle.dmxlive.core.fixture.AbstractFixture.OP_MODE;
import static com.kevinisabelle.dmxlive.core.fixture.AbstractFixture.OP_PULSE;
 ...
 * @author kevin
 */
public class LumiMKII extends AbstractFixture {
	...
	private List<TimedDmxValue> fade(TimeInfo time, TimeSignature signature, int bpm, Color[] colors, Integer[] dimmerPercent, TimeInfo executionTime) {
		...
		int numberOfIntervals = Long.valueOf(totalTime * 20 / 1000l).intValue();
	...
	@Override
	public List<DmxFunction> getSupportedFunctions() {
		throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
	}
}
