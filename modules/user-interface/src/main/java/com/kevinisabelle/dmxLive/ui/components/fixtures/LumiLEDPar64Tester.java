...
import com.kevinisabelle.dmxlive.fixture.lumiledpar64.LumiLEDPar64;
 ...
 * @author kisabelle
 */
public class LumiLEDPar64Tester extends JPanel implements ActionListener {
	
	private DmxLiveFunctionsTesterWindow parent = null;
	private LumiLEDPar64 fixture = new LumiLEDPar64();
	...
	private JComboBox modeNameCombo = new JComboBox(new String[]{"pulse", "fadein", "fadeout", "cycle", "cycle2"});
	...
	public LumiLEDPar64Tester(int channel, DmxLiveFunctionsTesterWindow parent){
	...
	private void executeFade(){
		...
		String scriptStr = "1:0:0|Par64_" + this.fixture.getChannel() + "|Fade:" + 
