 ...
 * @author kisabelle
 */
public class CommandBlink extends AbstractDMXCommand {

    public CommandBlink(TimeInfo startOffset, List<DMXFixture> fixtures, int scriptLineRef, String scriptItem, Color color, int dimmer) {
