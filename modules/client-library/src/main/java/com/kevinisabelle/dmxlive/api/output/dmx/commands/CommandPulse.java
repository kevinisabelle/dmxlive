 ...
 * @author kisabelle
 */
public class CommandPulse extends AbstractDMXCommand {

    public CommandPulse(TimeInfo startOffset, List<DMXFixture> fixtures, int scriptLineRef, String scriptItem, Color color, int dimmer) {
