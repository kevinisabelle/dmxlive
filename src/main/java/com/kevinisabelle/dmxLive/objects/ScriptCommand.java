...
import com.kevinisabelle.dmxLive.objects.fixtures.Fixture;
	...
	public List<TimedDmxValue> getTimedDmxValues(TimeInfo timeOffset, TimeSignature signature, int bpm, String[] parameters) {
		...
		if (scriptName != null) {
			...
			try {
				...
				JOptionPane.showMessageDialog(DmxLive.getCurrentFrame(), "Cannot find sub-script named: " + scriptName + ", " + e.getMessage());
			}
